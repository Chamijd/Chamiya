    ...
    try {
      ...
      if (action === "on") {
        ...
        if (initialNews) {
          ...
          reply("* FrozenQueen Warning:* Failed to fetch initial Hiru news. API may be down. Continuing with updates...");
        }
...
* CHAMA-MD-V1 Auto News Generated *
      `,
    };
